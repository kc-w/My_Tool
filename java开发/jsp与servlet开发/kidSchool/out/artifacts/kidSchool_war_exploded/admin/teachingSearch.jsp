...
<div class="modal" id="b" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="/TeachingServlet" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="control-label col-lg-3">幼儿id</label>
                            <div class="col-lg-5">
                                <input type="text" name="kidId" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-3">教师id</label>
                            <div class="col-lg-5">
                                <input type="text" name="teacherId" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-3">上课时间</label>
                            <div class="col-lg-5">
                                <input type="text" name="teachDate" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-3">上课内容</label>
                            <div class="col-lg-5">
                                <input type="text" name="content" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-3">上课效果</label>
                            <div class="col-lg-5">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <button data-target="#b" class="btn btn-warning" id="change" value="${teaching.id}">修改</button>
                        <button class="btn btn-danger"><a href="/TeachingServlet?mark=delete&id=${teaching.id}">删除</a></button>
                    </td>
                </tr>
                </c:forEach>
                </tbody>
