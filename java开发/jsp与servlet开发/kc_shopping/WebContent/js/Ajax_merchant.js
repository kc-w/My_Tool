$(document).ready(function(){
	...
	$("#txtUserName").blur(function(){
		$.ajax({
			url:"/kc_shopping/servlet_merchant/merchant_number",
			type:"post",
	...
	$("#password").blur(function(){
		$.ajax({
			url:"/kc_shopping/servlet_merchant/merchant_password",
			type:"post",
	...
	$("#txtUseremail").blur(function(){
		$.ajax({
			url:"/kc_shopping/servlet_merchant/merchant_email",
			type:"post",
	...
	$("#txtUsertelephone").blur(function(){
		$.ajax({
			url:"/kc_shopping/servlet_merchant/merchant_telephone",
			type:"post",
