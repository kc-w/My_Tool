...
//读取xml解析
void MainWindow3::redxml(QFile * file)
{
    ...
    while(!n.isNull())
    {
        ...
        if (n.isElement())
        {
            ...
            // 返回元素标记和id属性的值
            qDebug() << e.tagName()<< e.attribute("编号");
...
void MainWindow3::writexml(QFile * file){
    QDomDocument doc;
...
void MainWindow3::doXml(const QString operate)
{
    ui->listWidget->clear();
